...
<div class="tab-pane fade" id="formacao" role="tabpanel">
    ...
    <?php foreach ($pesquisador['formacao'] as $f): ?>
        <div class="card mb-4 bg-dark text-light border border-secondary rounded-4 shadow-sm p-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <p class="text-white-50 mb-1"><small>Status</small></p>
                    <p class="fw-semibold"><?= $f['status_curso'] ?></p>
                </div>

                <div class="col-md-4">
                    <p class="text-white-50 mb-1"><small>Bolsa</small></p>
                    <p class="fw-semibold"><?= $f['flag_bolsa'] ?></p>
                </div>

                <div class="col-md-4">
                    <p class="text-white-50 mb-1"><small>Orientador</small></p>
